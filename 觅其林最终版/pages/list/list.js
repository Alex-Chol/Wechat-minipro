...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://47.100.78.99/12345.json',
      method: 'GET',
      data: {},
      header: {
  ...
  selectInfo: function (e) {
    ...
    wx.request({
      url: 'http://47.100.78.99/demo/getgooddata.php?id='+type+index,
      method:'GET',
      success:function(res){
        console.log(res.data)
        that.setData({

          goodsum:res.data.good
        })
      }
    })
  },
  ...
  clickgood:function(){
    var that = this;
    var newgood = this.data.goodsum;
    var index1 = this.data.currentType;
    var index2 = this.data.currentIndex;
    wx.request({
      url: 'http://47.100.78.99/demo/postgooddata.php?id='+index1+index2+'&good='+newgood,
      method:"GET",
      success:function(res){
        that.setData({
          goodsum: parseInt(newgood)+1
        })
        console.log(res);
      }
    })
